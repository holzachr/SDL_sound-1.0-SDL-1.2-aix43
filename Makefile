...
pkgdatadir = $(datadir)/SDL_sound
pkgincludedir = $(includedir)/SDL_sound
pkglibdir = $(libdir)/SDL_sound
pkglibexecdir = $(libexecdir)/SDL_sound
...
target_triplet = powerpc-ibm-aix4.3.3.0
subdir = .
...
am__aclocal_m4_deps = $(top_srcdir)/acinclude/libtool.m4 \
	...
	$(top_srcdir)/acinclude/sdl2.m4 $(top_srcdir)/configure.ac
...
am__DEPENDENCIES_1 =  \
	decoders/timidity/libtimidity.la
am__DEPENDENCIES_2 = decoders/libdecoders.la $(am__DEPENDENCIES_1)
#libSDL2_sound_la_DEPENDENCIES = $(am__DEPENDENCIES_2)
...
#am_libSDL2_sound_la_OBJECTS = $(am__objects_1)
...
#am_libSDL2_sound_la_rpath = -rpath $(libdir)
libSDL_sound_la_DEPENDENCIES = $(am__DEPENDENCIES_2)
am__libSDL_sound_la_SOURCES_DIST = SDL_sound.c SDL_sound_internal.h \
	alt_audio_convert.c alt_audio_convert.h audio_convert.c
am_libSDL_sound_la_OBJECTS = $(am__objects_1)
...
am_libSDL_sound_la_rpath = -rpath $(libdir)
DEFAULT_INCLUDES = -I.
...
ACLOCAL = ${SHELL} /mnt/pub/source/SDL_sound-stable-1.0/build-scripts/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AS = as
AUTOCONF = ${SHELL} /mnt/pub/source/SDL_sound-stable-1.0/build-scripts/missing --run autoconf
AUTOHEADER = ${SHELL} /mnt/pub/source/SDL_sound-stable-1.0/build-scripts/missing --run autoheader
AUTOMAKE = ${SHELL} /mnt/pub/source/SDL_sound-stable-1.0/build-scripts/missing --run automake-1.11
AWK = nawk
BINARY_AGE = 3
CC = cc -qlanglvl=extc89
CCDEPMODE = depmode=aix
CFLAGS = -qmaxmem=32768 -qcpluscmt -qarch=com -DSYSV -D_AIX -D_AIX32 -D_AIX41 -D_AIX43 -D_ALL_SOURCE -DXTHREADS -D_REENTRANT -D_THREAD_SAFE -DFUNCPROTO=15 -O3 -I/opt/freeware/include -I/usr/lpp/UMS/include -I/usr/lpp/som/include -I/opt/SDL/include/SDL -D_GNU_SOURCE=1 -D_AIX -DXTHREADS -D_REENTRANT -D_THREAD_SAFE
...
GREP = /usr/bin/grep
INSTALL = build-scripts/install-sh -c
...
LT_REVISION = 3
MAJOR_VERSION = 1
MAKEINFO = ${SHELL} /mnt/pub/source/SDL_sound-stable-1.0/build-scripts/missing --run makeinfo
MICRO_VERSION = 4
MINOR_VERSION = 0
MKDIR_P = build-scripts/install-sh -c -d
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = false
OBJEXT = o
...
STRIP = strip
VERSION = 1.0.4
abs_builddir = /mnt/pub/source/SDL_sound-stable-1.0
abs_srcdir = /mnt/pub/source/SDL_sound-stable-1.0
abs_top_builddir = /mnt/pub/source/SDL_sound-stable-1.0
abs_top_srcdir = /mnt/pub/source/SDL_sound-stable-1.0
ac_ct_CC = cc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /mnt/pub/source/SDL_sound-stable-1.0/build-scripts/install-sh
...
mkdir_p = $(top_builddir)/build-scripts/install-sh -c -d
...
libSDL2_sound.la: $(libSDL2_sound_la_OBJECTS) $(libSDL2_sound_la_DEPENDENCIES) $(EXTRA_libSDL2_sound_la_DEPENDENCIES) 
	$(libSDL2_sound_la_LINK) $(am_libSDL2_sound_la_rpath) $(libSDL2_sound_la_OBJECTS) $(libSDL2_sound_la_LIBADD) $(LIBS)
libSDL_sound.la: $(libSDL_sound_la_OBJECTS) $(libSDL_sound_la_DEPENDENCIES) $(EXTRA_libSDL_sound_la_DEPENDENCIES) 
...
include ./$(DEPDIR)/SDL_sound.Plo
include ./$(DEPDIR)/alt_audio_convert.Plo
include ./$(DEPDIR)/audio_convert.Plo
...
install-libSDL2_soundincludeHEADERS: $(libSDL2_soundinclude_HEADERS)
	...
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(libSDL2_soundincludedir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(libSDL2_soundincludedir)" || exit 1; \
	fi; \
	for p in $$list; do \
...
uninstall-libSDL2_soundincludeHEADERS:
	...
	dir='$(DESTDIR)$(libSDL2_soundincludedir)'; $(am__uninstall_files_from_dir)
install-libSDL_soundincludeHEADERS: $(libSDL_soundinclude_HEADERS)
	@$(NORMAL_INSTALL)
	@list='$(libSDL_soundinclude_HEADERS)'; test -n "$(libSDL_soundincludedir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(libSDL_soundincludedir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(libSDL_soundincludedir)" || exit 1; \
	fi; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  echo "$$d$$p"; \
	...
	while read files; do \
	  echo " $(INSTALL_HEADER) $$files '$(DESTDIR)$(libSDL_soundincludedir)'"; \
	  $(INSTALL_HEADER) $$files "$(DESTDIR)$(libSDL_soundincludedir)" || exit $$?; \
	done
...
uninstall-libSDL_soundincludeHEADERS:
	...
	@list='$(libSDL_soundinclude_HEADERS)'; test -n "$(libSDL_soundincludedir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(libSDL_soundincludedir)'; $(am__uninstall_files_from_dir)
